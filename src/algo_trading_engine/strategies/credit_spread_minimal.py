...
class CreditSpreadStrategy(Strategy):
    ...
    def __init__(self, get_contract_list_for_date: Callable, get_option_bar: Callable, get_options_chain: Callable, lstm_model, lstm_scaler, symbol: str = 'SPY', options_handler=None):
