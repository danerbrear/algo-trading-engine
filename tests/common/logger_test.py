...
class TestConfigureLogger:
    ...
    def test_creates_log_dir_and_backtest_log_file(self):
    ...
    def test_creates_trade_log_file(self):
        with tempfile.TemporaryDirectory() as tmpdir:
    ...
    def test_overwrites_file_on_reconfigure(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            configure_logger("backtest", log_dir=tmpdir, log_level="info")
...
class TestLogAndEcho:
    ...
    def test_log_and_echo_writes_to_file(self, capsys):
        with tempfile.TemporaryDirectory() as tmpdir:
            configure_logger("backtest", log_dir=tmpdir, log_level="info")
    ...
    def test_log_and_echo_prints_to_stdout(self, capsys):
        with tempfile.TemporaryDirectory() as tmpdir:
            configure_logger("backtest", log_dir=tmpdir, log_level="info")
