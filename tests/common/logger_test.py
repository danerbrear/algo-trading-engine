...
from algo_trading_engine.common.logger import configure_logger, get_logger, log_and_echo, remove_logger_sink
...
class TestLogAndEcho:
    ...
    def test_log_and_echo_writes_to_file(self, tmp_log_dir):
        tmpdir = tmp_log_dir
        configure_logger('backtest', log_dir=tmpdir, log_level='info')
